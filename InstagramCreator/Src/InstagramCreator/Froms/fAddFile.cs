...
using InstagramCreator.ProxyDroid;
using Serilog;
...
namespace InstagramCreator.Froms
{
    public partial class fAddFile : Form
    {
                ...
                case "Accounts":
                    {
                        ...
                        ckbCatchAll.Visible = true;
                        ckbCatchAll.Checked = SettingsTool.GetSettings("configGeneral").GetBooleanValue("ckbCatchAll");
                        return;
                    }
                case "EmailRecovery":
                    {
                        ckbCatchAll.Visible = true;
                        ckbCatchAll.Checked = SettingsTool.GetSettings("configGeneral").GetBooleanValue("ckbCatchAll");
                        ckbCatchAll_CheckedChanged(null, null);
                        return;
                    }
                default:
                    {
        ...
        private void ckbCatchAll_CheckedChanged(object sender, EventArgs e)
        {
            lbNotifi.Text = "Format: email|password|server|port";
            if (ckbCatchAll.Checked)
            {
                lbNotifi.Text = "Format: domain|password|server|port";
            }
        }
    }
}
