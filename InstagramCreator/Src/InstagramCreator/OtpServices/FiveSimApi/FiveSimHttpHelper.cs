...
namespace InstagramCreator.FiveSimApi
{
    public class FiveSimHttpHelper
    {
        public static async Task<HttpResponseModel> BuyPhoneNumber(string country, string key, string operaTor)
        {
            try
            {
                ...
                string query = "v1/user/buy/activation/" + country + "/" + operaTor + "/instagram";
